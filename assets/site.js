...
(function () {
  ...
  /* --- 9. Date structurate ------------------------------------------------
     Nu mai sunt construite aici. JSON-LD-ul e scris direct în <head>-ul
     fiecărei pagini de `tools/seo.js`, din config.js și din textul paginii,
     ca să se vadă în view-source: crawlerele de AI nu rulează JavaScript.
     Numărul secțiunii a rămas, ca trimiterile din CLAUDE.md să fie adevărate. */
